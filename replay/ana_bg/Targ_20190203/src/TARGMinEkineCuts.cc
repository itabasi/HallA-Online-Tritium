...
//
//
// $Id: HRSMinEkineCuts.cc 69148 2013-04-19 10:35:21Z gcosmo $
//
// 
// --------------------------------------------------------------
...
TARGMinEkineCuts::TARGMinEkineCuts(const G4String& aName)
  : TARGSpecialCuts(aName)
{
    if (verboseLevel>1) {
...
TARGMinEkineCuts::TARGMinEkineCuts(TARGMinEkineCuts&)
  : TARGSpecialCuts()
{}


G4double TARGMinEkineCuts::PostStepGetPhysicalInteractionLength(
