...
//====== Cut condition ========================// 
 ...
 TH2F* hAC=new TH2F("hAC","AC threshold",iter_ac1+1,min_ac1,th1_max,11,0.,10.);
...
//  bg_2[i][th2][0]=fbg[i][th2][0]->GetParameter(2);
  ...
  gS_eff_ac2[th1]->SetPoint(i,th_ac2[i],nS[i][th1][1]/nS[0][th1][1]);
   ...
   totL_ac2[i][2]=hmm_ac2_all_p[i][th1]->Integral(hmm_ac2_all_p[i][th1]->FindBin(-3*sigL[i][th1][1]+meanL[i][th1][1])
					     ,hmm_ac2_all_p[i][th1]->FindBin(+3*sigL[i][th1][1]+meanL[i][th1][1]));
   bgL_ac2[i][th1]= totL_ac2[i][2]-nL[i][th1][1];
