...
*/
 ...
 crpathl->Divide(2,2);
 crpathl->cd(1);
 set->SetTH2(hcoin_rpathl,"","","");
 crpathl->cd(1)->SetLogz();
 ...
 crpathl->cd(2);
 set->SetTH2(hcoin_lpathl,"","","");
 crpathl->cd(2)->SetLogz();
 ...
 crpathl->cd(3);
 set->SetTH2(hcoin_rpathl_cc,"","","");
 crpathl->cd(3)->SetLogz();
 ...
 crpathl->cd(4);
 set->SetTH2(hcoin_lpathl_cc,"","","");
 crpathl->cd(4)->SetLogz();
