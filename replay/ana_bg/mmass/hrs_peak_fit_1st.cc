...
void hrs_peak_fit_1st(){
  
  //  TFile *fin=new TFile("./../../rootfiles/Lambda_small1_mm_ana1222.root");
   TFile *fin=new TFile("./../rootfiles/mmass/ana_Lambda/Lambda_small_H_mm.root");  // 1st tuning
   //  TFile *fin=new TFile("./../rootfiles/mmass/ana_Lambda/Lambda_small_H_mm_0th.root");  //0th tuning
  ...
  //======== Lambda B.G. ============//
  TF1*  fbg_L=new TF1("fbg_L","pol1(0)",1.02,1.3);  
  ...
  fpeak_S->SetParameter(0,1.06770); 
  fpeak_S->SetParameter(1,1.19941);
  fpeak_S->SetParameter(2,4.9135e-3);
