...
/////////////////////////////////////////////////////
void Tree::readtreeTuned(){

  tree->SetBranchStatus("R.tr.tg_th_c"              ,1);
  tree->SetBranchStatus("R.tr.tg_ph_c"              ,1);
  tree->SetBranchStatus("R.tr.vx_c"                 ,1);
  tree->SetBranchStatus("R.tr.vx_c"                 ,1);
  tree->SetBranchStatus("R.tr.vy_c"                 ,1);
  tree->SetBranchStatus("R.tr.vz_c"                 ,1);
  tree->SetBranchStatus("L.tr.tg_th_c"              ,1);
  tree->SetBranchStatus("L.tr.tg_ph_c"              ,1);
  tree->SetBranchStatus("L.tr.vx_c"                 ,1);
  tree->SetBranchStatus("L.tr.vx_c"                 ,1);
  tree->SetBranchStatus("L.tr.vy_c"                 ,1);
  tree->SetBranchStatus("L.tr.vz_c"                 ,1);

  
  //------ RHRS ---------//
  tree->SetBranchAddress("R.tr.tg_th_c"           , R_tr_tg_th_c );
  tree->SetBranchAddress("R.tr.tg_ph_c"           , R_tr_tg_ph_c );
  tree->SetBranchAddress("R.tr.vx_c"              , R_tr_vx_c    );
  tree->SetBranchAddress("R.tr.vy_c"              , R_tr_vy_c    );
  tree->SetBranchAddress("R.tr.vz_c"              , R_tr_vz_c    );
  //------ LHRS --------//
  tree->SetBranchAddress("L.tr.tg_th_c"           , L_tr_tg_th_c );
  tree->SetBranchAddress("L.tr.tg_ph_c"           , L_tr_tg_ph_c );
  tree->SetBranchAddress("L.tr.vx_c"              , L_tr_vx_c    ); 
  tree->SetBranchAddress("L.tr.vy_c"              , L_tr_vy_c    );
  tree->SetBranchAddress("L.tr.vz_c"              , L_tr_vz_c    );
