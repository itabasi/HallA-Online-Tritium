...
//====== Cut condition ========================// 
 ...
 //--------- with AC1 Cut ---------------// 
  for(int j=0;j<nth;j++){
   ...
   if(cut_ac1 && Ra2sum<th2_max){
    ...
    //------- ACC BG -------------------------------------------------------------//
    if(mode=="T" &&(-63<coin_tc && coin_tc <-15) || (15<coin_tc && coin_tc<63) ){
       double ct=coin_tc;       
        while(1){
	  if(-3.0<ct && ct<3.0){
		 hcoin_acc_ac2[j]->Fill(ct);
                 hcoin_acc_ac2[j]->Fill(ct-36);
		 break;}
 ...
 //------- ACC BG -------------------------------------------------------------//
    if(mode=="T" &&(-63<coin_tc && coin_tc <-15) || (15<coin_tc && coin_tc<63) ){
       double ct=coin_tc;       
        while(1){
	  if(-3.0<ct && ct<3.0){
		 hcoin_acc_ac1[k]->Fill(ct);
                 hcoin_acc_ac1[k]->Fill(ct-36);
		 break;}
	       else if(ct<-3.0){ct=ct+6;}
	       else if(3.0<ct){ct=ct-6;}
	 }
 ...
 for(int i=0;i<nth;i++){
 hcoin_acc_ac1[i]->Scale(6.0/96.);
 hcoin_acc_ac2[i]->Scale(6.0/96.);
 }
...
//======== Draw TCanvas ==============//
 ...
 ck1[th2]->cd();
     ...
     //	}
       ...
       gSN_k_ac1[1][2]->SetMaximum(5.0);
       gSN_k_ac1[1][0]->SetMinimum(0.0);
       gSN_k_ac1[1][0]->SetMaximum(5.0);
       gSN_k_ac1[1][1]->SetMinimum(0.0);
       gSN_k_ac1[1][1]->SetMaximum(5.0);
       ...
       gSN_k_ac2[2][0]->SetMaximum(10.0);
       gSN_k_ac2[2][1]->SetMinimum(0.0);
       gSN_k_ac2[2][1]->SetMaximum(10.0);
