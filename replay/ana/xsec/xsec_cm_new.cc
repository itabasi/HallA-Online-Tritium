...
const  double MT  =  2.808921112;
  ...
  //  XS = XS_Lab*XS_Lab_to_cm*2.0*3.14; // dsig/dcos
  XS = XS_Lab/XS_Lab_to_cm;
  


  XS =400.;
  double Nhyp = XS*kaon_survival_ratio*NT*Ngamma/1.0e9*accept_cm/cm_to_barn;


  
  cout<<"Nhyp "<<Nhyp<<" XS_cm "<<XS<<" Lab_to_cm "<<XS_Lab_to_cm<<endl;    
  cout<<"Nhyp_Lab "<<Nhyp_Lab<<" XS_lab "<<XS_Lab<<" fac "<<1./XS_Lab_to_cm<<endl;   
  cout<<" theta "<<acos(cos)*180./3.14<<" theta_ "<<acos(cos_)*180./3.14<<endl;
  cout<<" accept "<<accept_lab<<" accept_cm "<<accept_cm<<endl; 
