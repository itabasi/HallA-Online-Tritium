...
matrix="../momcalib/matrix/momcalib_matrix_new2.list"
...
def ana(i):            
    ...
    MODE=mode[i]
    pfile=param[i]
    cmd=f'./bin/ana_Lambda -s ../rootfiles/mmass/ana_Lambda/initial/{names}.root -p param/{pfile} -r {root_dir}/{names}.root -w {pdf_dir}/{names}.pdf -m {matrix} -{MODE} -C'
    print(cmd)
