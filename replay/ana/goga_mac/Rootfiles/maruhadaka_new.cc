...
void maruhadaka_new(){
  ...
  char inputfname[500], newfname[500];;
    ...
    sprintf(inputfname,"/data3/root_ole/root2/tritium_111200.root");

    sprintf(newfname,"./test.root");
  ...
  for(int i=0 ; i<ent ; i++){
	...
	cout<<"  === events ======"<<endl;
	cout<<"meantime_L "<<meantime_L<<" meantime_R "<<meantime_R<<endl;
	cout<<" cor_L "<<cor_L<<" cor_R "<<cor_R<<endl;

	cout<<"ctime "<<ctime[0]<<" ctimecorL "<<ctimecorL<<" ctimecorR "<<ctimecorR<<endl;
