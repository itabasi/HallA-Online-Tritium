...
int main(int argc, char** argv){
  ...
  sprintf(name_Mxt_R,"./newpar_xpt_4.dat");
  sprintf(name_Myt_R,"./newpar_ypt_4.dat");
  ...
  //h1->Draw();
  for(int i=0 ; i<nfoil ; i++){
    c1->cd(i+1);h2[i]->Draw("cont4");
    c2->cd(i+1);h2_new[i]->Draw("cont4");
  }
