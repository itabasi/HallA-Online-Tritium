...
int main(int argc, char** argv){
  ...
  if(argc==1){
    ...
    //sprintf(RootFileName1,"T2_20190920.root");
    nite = 0;
  }
  else if(argc==2){
    nite = atoi(argv[1]);
  ...
  //sprintf(name_MctimecorL,"newpar_ctimeL_29.dat"); 
  //sprintf(name_MctimecorR,"newpar_ctimeR_29.dat"); 
  sprintf(name_MctimecorL,"../../matrices/ctimeL_h2.dat"); 
  sprintf(name_MctimecorR,"../../matrices/ctimeR_h2.dat"); 
