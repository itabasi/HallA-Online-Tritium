...
void mm(){
  TFile* f1 = new TFile("h2_20200115.root");
  //TFile* f1 = new TFile("h22_20191212.root");
  //TFile* f1 = new TFile("He3_20191212.root");
  //TFile* f1 = new TFile("T2_20191212.root");
  ...
  h5->GetYaxis()->SetRangeUser(0.0,50.0);
