...
void nLambda(){
  ...
  //h_kaon->Fit("func1","NB","",-2.0,2.0);
  h_kaon->Fit("func1","NB","",-0.5,0.5);
  h_kaon->GetXaxis()->SetRangeUser(-3.0,3.0);
  ...
  hh2_noacc->Fit("func2","NB","",-8.0,3.0);
  ...
  func3->SetNpx(1000);
  hh2_noacc->Fit("func3","NB","",73.0,78.0);
  func3->Draw("same");
  func2->SetLineColor(9);
  ...
  areaL = func2->Integral(-50,50);
  nL = areaL * convf;
  areaS = func3->Integral(-50,1000);
  nS = areaS * convf;
