...
const double mp = 25.12650524; // Al27
const double mL = 24.19650327 + 1.115683; // Mg26
...
void mixed_event(){
  TFile* f1 = new TFile("Al_20190927.root");
