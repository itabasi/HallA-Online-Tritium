...
int main(int argc, char** argv){
  ...
  if(argc==1){
    ...
    sprintf(RootFileName,"h2_20190919.root");
    nite = 0;
  }
  else if(argc==2){
    nite = atoi(argv[1]);
  ...
  TFile* f1 = new TFile("h2_20190919.root");
  TTree* t1 = (TTree*)f1->Get("tree");
  //TFile* f2 = new TFile("h22_20190803.root");
  TFile* f2 = new TFile("h22_20190919.root");
  ...
  sprintf(name_Mmom_L,"newpar_lmom_99.dat"); 
  sprintf(name_Mmom_R,"newpar_rmom_99.dat"); 
