...
int main(int argc, char** argv){
  ...
  TFile* fnew = new TFile("check_histo.root","recreate");
  ...
  sprintf(name_Mxpt,"newpar/newpar_xpt_14.dat");  // x'
  sprintf(name_Mypt,"newpar/newpar_ypt_14.dat");  // y'
