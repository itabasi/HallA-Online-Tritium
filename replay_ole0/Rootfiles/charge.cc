/*
  ...
  This was given by Nathaly and,
  modifed a bit by Toshi Gogami on March 11, 2020
*/
...
//const TString rootfilePath = "/Users/nathalysantiesteban/Documents/JLabWork/Tritium/";
  const TString rootfilePath = "nnL/";
  ...
  */
  ...
  double mean_bc = 0.0;
  mean_bc = Charge_d3 + Charge_un + Charge_dn;
  mean_bc = mean_bc/3.0;
  cout << " " << run << " " << mean_bc << endl;
  cout << endl;
  cout << endl;


  ofstream* ofs = new ofstream(outfilename,ios_base::app);
  *ofs << run << " " << mean_bc << endl;
  ofs->close();
